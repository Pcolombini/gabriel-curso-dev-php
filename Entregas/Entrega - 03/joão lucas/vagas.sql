...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 27-Set-2021 às 22:02
...
CREATE TABLE IF NOT EXISTS `candidatos` (
  ...
  `telefone_candidato` char(11) NOT NULL,
  `email_candidato` varchar(255) NOT NULL,
  `resumo_candidato` varchar(255) NOT NULL,
  `idiomas_candidato` varchar(255) NOT NULL,
  `disponivel_candidato` char(1) NOT NULL,
  `fk_id_cidade_cidades` int UNSIGNED NOT NULL,
  `fk_id_vaga_vagas` int UNSIGNED NOT NULL,
  PRIMARY KEY (`id_candidato`),
  KEY `fk_id_cidade_cidades` (`fk_id_cidade_cidades`),
  KEY `fk_id_vaga_vagas` (`fk_id_vaga_vagas`)
...
CREATE TABLE IF NOT EXISTS `cidades` (
  ...
  `fk_id_estado_estados` int UNSIGNED NOT NULL,
  PRIMARY KEY (`id_cidade`),
  KEY `fk_id_estado_estados` (`fk_id_estado_estados`)
) ENGINE=InnoDB AUTO_INCREMENT=5610 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Extraindo dados da tabela `cidades`
--

INSERT INTO `cidades` (`id_cidade`, `nome_cidade`, `fk_id_estado_estados`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `estados` (`id_estado`, `nome_estado`, `uf_estado`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
INSERT INTO `vagas` (`id_vaga`, `nome_vaga`, `desc_vaga`) VALUES
(1, 'Desenvolvedor Web', 'Nesse cargo você ira ajudar a desenvolver sites no quesito back-end e front-end'),
(2, 'Médico', 'Você ira trabalhar em um hospital como ajudante de profissionais'),
(3, 'Engenheiro', 'Você ira ajudar engenheiros profissionais nos calculos e designs'),
(4, 'Designer', 'Você ira produzir designs de sites que serão usados por programadores'),
(5, 'Dentista', 'Você ira ajudar no tratamento do dente de crianças e adolescentes');
...
ALTER TABLE `candidatos`
  ADD CONSTRAINT `fk_id_cidade_cidades` FOREIGN KEY (`fk_id_cidade_cidades`) REFERENCES `cidades` (`id_cidade`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_vaga_vagas` FOREIGN KEY (`fk_id_vaga_vagas`) REFERENCES `vagas` (`id_vaga`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `cidades`
--
ALTER TABLE `cidades`
  ADD CONSTRAINT `cidades_ibfk_1` FOREIGN KEY (`fk_id_estado_estados`) REFERENCES `estados` (`id_estado`);
COMMIT;
