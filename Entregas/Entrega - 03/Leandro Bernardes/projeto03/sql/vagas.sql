...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Set-2021 às 13:26
...
CREATE TABLE `tbl_candidatos` (
  ...
  `phone_candidato` varchar(255) NOT NULL,
  `email_candidato` varchar(255) NOT NULL,
  `fk_id_cidade_cidades` int(11) NOT NULL,
  `fk_id_vaga_vagas` int(11) NOT NULL,
  `resumo_candidato` varchar(500) NOT NULL,
  `idiomas_candidato` varchar(255) NOT NULL,
  `local_candidato` char(1) NOT NULL DEFAULT 'F'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `tbl_candidatos`
--

INSERT INTO `tbl_candidatos` (`id_candidato`, `nome_candidato`, `phone_candidato`, `email_candidato`, `fk_id_cidade_cidades`, `fk_id_vaga_vagas`, `resumo_candidato`, `idiomas_candidato`, `local_candidato`) VALUES
(1, 'Leandro', '994923533', 'leandro@gmail.com', 282, 3, 'Trabalhou na Vitae Center', 'ingles espanhol', 'V'),
(2, 'Davi', '994443333', 'davi@gmail.com', 698, 3, 'Trabalhou em petroleolandia', 'ingles ', 'F'),
(6, 'Vinicius', '11112222', 'vini@hotmail.com', 1566, 2, 'Buscando Estagio', 'ingles espanhol', 'F'),
(7, 'Luiz Otavio', '88887777', 'luiz@g.com', 3185, 3, 'Trabalhando na empresa petrobras', 'ingles ', 'V'),
(8, 'Leticia', '66665555', 'let@gg.com', 1237, 2, 'Trabalhou de maneira autonoma', 'ingles ', 'F');
...
CREATE TABLE `tbl_cidades` (
  ...
  `fk_id_estado_estados` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_cidades` (`id_cidade`, `nome_cidade`, `fk_id_estado_estados`) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `tbl_estados` (`id_estado`, `nome_estado`, `uf_estado`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
--
-- Extraindo dados da tabela `tbl_vagas`
--

INSERT INTO `tbl_vagas` (`id_vaga`, `nome_vaga`, `desc_vaga`) VALUES
(1, 'Estagiário - Suporte Técnico', 'Você trabalhará com nossas áreas responsáveis pela empatia e proximidade com nossos clientes'),
(2, 'Estagiário - UX/UI', 'Você ajudará a gente a ditar o ritmo do mercado, fazendo tecnologia que transforma'),
(3, 'Estagiário - Desenvolvimento de Software', 'Você ajudará a gente a projetar, criar e manter sites e aplicativos web.');
...
ALTER TABLE `tbl_candidatos`
  ...
  ADD KEY `fk_id_vaga_vagas` (`fk_id_vaga_vagas`),
  ADD KEY `fk_id_cidade_cidades` (`fk_id_cidade_cidades`);
...
ALTER TABLE `tbl_cidades`
  ...
  ADD KEY `fk_id_estado_estados` (`fk_id_estado_estados`);
...
--
ALTER TABLE `tbl_cidades`
  MODIFY `id_cidade` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5611;

--
-- AUTO_INCREMENT de tabela `tbl_estados`
--
ALTER TABLE `tbl_estados`
  MODIFY `id_estado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
-- Limitadores para a tabela `tbl_candidatos`
--
ALTER TABLE `tbl_candidatos`
  ADD CONSTRAINT `fk_id_cidade_cidades` FOREIGN KEY (`fk_id_cidade_cidades`) REFERENCES `tbl_cidades` (`id_cidade`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_vaga_vagas` FOREIGN KEY (`fk_id_vaga_vagas`) REFERENCES `tbl_vagas` (`id_vaga`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `tbl_cidades`
--
ALTER TABLE `tbl_cidades`
  ADD CONSTRAINT `fk_id_estado_estados` FOREIGN KEY (`fk_id_estado_estados`) REFERENCES `tbl_estados` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
